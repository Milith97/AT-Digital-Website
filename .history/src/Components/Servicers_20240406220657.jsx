...
const Servicers = () => {
    return (
        <div className="flex flex-col md:flex-row place-items-center justify-center">
            <div className=" lg:w-2/5 xl:w-2/5 flex-shrink-0 mb-6 md:mb-0 mr-0 md:mr-6">        
                <img src={Service1} alt="Service Image" className="w-full h-full object-cover" />
            </div>

            {/* Right Side (Content) */}
            <div className="max-w-lg">
                <h2 className="sm:text-3xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text:4xl  font-bold mb-4 text-[#6B3CC9]">Web & Mobile App Development</h2>
                <p className="lg:w-3/5 sm:text-xl md:text-lg lg:text-lg xl:text-base 2xl:text-xl font-normal  mb-6 ">Your web and mobile Apps are pieces of the puzzle to grow your business. We use frameworks which tailor content and engagement methods to respond to different intents shown by your potential customers who interact with your business online.</p>
