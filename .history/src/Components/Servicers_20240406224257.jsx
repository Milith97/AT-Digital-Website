...
const Services = () => {
    return (
        <div className="flex flex-col md:flex-row items-center justify-center">
            {/* Left Side (Image) */}
            <div className="w-414 h-414  flex-shrink-0 mb-6 md:mb-0 mr-0 md:mr-6">
            ...
            <div className="md:max-w-lg lg:max-w-xl xl:max-w-2xl ">
                <h2 className="sm:text-black md:text-2xl lg:text-3xl xl:text-2xl 2xl:text:4xl  font-bold mb-4 text-[#6B3CC9]">Web & Mobile App Development</h2>
                <p className="sm:text-xs md:text-xs lg:text-lg xl:text-lg 2xl:text-lg font-medium mb-6 md:mr-10">Your web and mobile Apps are pieces of the puzzle to grow your business. We use frameworks which tailor content and engagement methods to respond to different intents shown by your potential customers who interact with your business online.</p>
                <button className="bg-yellow-500 text-white font-bold py-2 px-6 rounded-lg hover:bg-yellow-600 transition-colors">LEARN MORE</button>
            </div>
        </div>
    );
