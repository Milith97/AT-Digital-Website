...
const Services = () => {
    return (
        <div className="flex flex-col lg:flex-row items-center justify-center">
            {/* Left Side (Image) */}
            <div className="w-full lg:w-2/5 mb-6 lg:mb-0 lg:mr-6">
                {/* Image with responsive size */}
                <img src="your_image_url.jpg" alt="Service Image" className="w-full lg:w-96 h-auto object-cover" />
            </div>

            {/* Right Side (Content) */}
            <div className="max-w-md">
                <h2 className="text-3xl sm:text-2xl lg:text-4xl font-semibold mb-4">Web & Mobile App Development</h2>
                <p className="text-lg sm:text-base lg:text-xl mb-6">Your web and mobile Apps are pieces of the puzzle to grow your business. We use frameworks which tailor content and engagement methods to respond to different intents shown by your potential customers who interact with your business online.</p>
                <button className="bg-yellow-500 text-white font-bold py-2 px-6 rounded-lg hover:bg-yellow-600 transition-colors">LEARN MORE</button>
            </div>
        </div>
    );
