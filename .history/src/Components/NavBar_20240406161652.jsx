...
const NavBar = () => {
    ...
    return (
        <nav className="bg-[#6B3CC9]">
            <div className="max-w-1440px mx-auto xl:px-11">
                <div className="flex justify-between">
                    ...
                    <div className={`hidden md:flex items-center space-x-1 ${isOpen ? 'flex' : 'hidden'}`}>
                        <a href="#" className="py-5 px-3 text-gray-200">SERVICES</a>
                        <a href="#" className="py-5 px-3 text-gray-200">ABOUT US</a>
                        <a href="#" className="py-5 px-3 text-gray-200">CONTACT US</a>
                        <a href="#" className="py-5 px-3 text-gray-200">CAREERS</a>
                    </div>
