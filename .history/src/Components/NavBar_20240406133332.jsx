    ...
    return (
        <nav className="bg-[#6B3CC9]">
                ...
                <div className="flex justify-between">
                    ...
                    <div className="md:hidden flex items-center">
                        <button onClick={() => setIsOpen(!isOpen)} className="text-white focus:outline-none">
                            {isOpen ? (
                                <svg className="CloseIcon" fill="none" stroke="black" viewBox="0 0 24 24"  style={{ width: "23px", height: "23px" }}>
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M6 18L18 6M6 6l12 12" />
                                </svg>
                            ) : (
                                <svg className="Hamburger" fill="none" stroke="white" viewBox="0 0 24 24" style={{ width: "23px", height: "23px" }}>
            ...
            <div className={`${isOpen ? 'block' : 'hidden'} md:hidden bg-white h-screen`}>
                ...
                <a href="#" className="block py-2 px-4 text-sm text-black-200 hover:bg-gray-700">Career</a>
            </div>
        </nav>
    );
};
