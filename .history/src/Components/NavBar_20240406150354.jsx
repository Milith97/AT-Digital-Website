...
const NavBar = () => {
    ...
    return (
        <nav className="bg-[#6B3CC9]">
                    ...
                    <div className="md:hidden flex items-center">
                        <button onClick={() => setIsOpen(!isOpen)} className="text-white focus:outline-none">
                            {!isOpen ? (
                                ...
                                <svg className="CloseIcon" stroke="black" viewBox="0 0 24 24" style={{ width: "23px", height: "23px", backgroundColor: isOpen ? 'transparent' : '#6B3CC9' }}>
            ...
            <div className={`${isOpen ? 'block' : 'hidden'} sm:hidden bg-white h-screen`}>
