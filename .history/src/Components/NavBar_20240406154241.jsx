            ...
            <div className="max-w-6xl mx-auto px-4">
                <div className="flex justify-between">
                    ...
                    <div className={`hidden md:flex items-center space-x-1 ${isOpen ? 'flex' : 'hidden'}`}>
                        <a href="#" className="px-3 text-gray-200 hover:text-gray-400">SERVICES</a>
                        <a href="#" className=" px-3 text-gray-200 hover:text-gray-400">ABOUT US</a>
                        <a href="#" className=" px-3 text-gray-200 hover:text-gray-400">CONTACT US</a>
                        <a href="#" className=" px-3 text-gray-200 hover:text-gray-400">CAREERS</a>
                    </div>
